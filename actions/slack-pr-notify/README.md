...
| `bar-color` | não | `#d4a72c` | Cor (hex) da barra lateral do card. Em falha de checks, usa vermelho automaticamente. |
...
| Aprovado (review) | 🔵 `Pull Request · Aprovado · Aguardando merge · Author: …` | azul |
