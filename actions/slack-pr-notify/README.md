...
O cabeçalho reflete o resultado: `✅ Pull Request — checks OK`, `❌ Pull Request — checks falharam`, `📝 Pull Request (rascunho)` ou `🔔 Pull Request` (quando `wait-for-checks: false`).
